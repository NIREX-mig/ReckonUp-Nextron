  ...
  return (
    <footer className="mt-5">
      <div className="w-1/3 text-center opacity-55">
        <p className="text-[11px] font-medium tracking-[3px] text-[#666]">Signature</p>
        ...
        <p className="text-[11px] tracking-[2px] text-[#666]">DD/MM/YYYY</p>
      </div>
      <p className="mt-4 text-[12px] tracking-[2px] text-center capitalize">

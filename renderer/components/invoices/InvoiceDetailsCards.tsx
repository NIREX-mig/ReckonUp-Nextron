  ...
  return (
    <div className="flex justify-between">
      ...
      <div className=" text-left px-4">
        <p className=" text-[12px] font-semibold  text-black">EXCHANGE DETAILS</p>
      ...
      <div className=" w-[200px] text-left px-4 font-bold border rounded-lg py-1">
        ...
        <p className="text-[12px] text-black capitalize">name: {customername}</p>
        <p className="text-[12px] text-black capitalize">Address: {customeraddress}</p>
        <p className="text-[12px] text-black capitalize">Phone: {customerphone}</p>
      </div>
    </div>
  );
};
